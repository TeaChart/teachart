...
require (
	...
	github.com/docker/docker v25.0.4-0.20240301160236-51e876cd964c+incompatible // indirect
...
replace github.com/yp05327/teachart/cmd => ./cmd

replace github.com/yp05327/teachart/pkg/app => ./pkg/app

replace github.com/yp05327/teachart/pkg/file => ./pkg/file

replace github.com/yp05327/teachart/pkg/chart => ./pkg/chart

replace github.com/yp05327/teachart/pkg/lint => ./pkg/lint

replace github.com/yp05327/teachart/pkg/lint/rules => ./pkg/lint/rules

replace github.com/yp05327/teachart/pkg/utils => ./pkg/utils

replace github.com/yp05327/teachart/cmd/teachart => ./cmd/teachart

replace github.com/yp05327/teachart/pkg/compose => ./pkg/compose
